...
const PRODUCTS_BY_CATEGORY = {
  Electronics: [
    ...
    },
    {
      ...
      description: '11" 2K IPS tablet with Snapdragon 870, 8GB RAM, and 13MP rear camera.',
      price: 449.99,
      subcategory: 'Tablets',
      attributes: { ram: '8GB', storage: '128GB', display: '11" 2K IPS' },
      tags: ['tablet', 'android', 'snapdragon'],
      variants: [
        { color: 'Graphite', stock: rand(10, 50) },
        { color: 'Pearl White', stock: rand(10, 50) },
      ],
    },
    {
      name: 'UltraHub USB-C 10-in-1',
      description: '10-in-1 USB-C hub with dual HDMI 4K, 100W PD, SD/TF card reader, and Gigabit Ethernet.',
      price: 69.99,
      subcategory: 'Peripherals',
      attributes: { ports: '10', hdmi: 'Dual 4K@60Hz', powerDelivery: '100W PD' },
      tags: ['usb-hub', 'usb-c', 'peripherals'],
      variants: [
        { color: 'Space Grey', stock: rand(20, 90) },
        { color: 'Silver', stock: rand(20, 90) },
      ],
    },
    {
      name: 'InkJet All-in-One Printer',
      description: 'Wireless colour inkjet printer with scan, copy, and auto-duplex printing at 22 ppm.',
      price: 129.99,
      subcategory: 'Printers',
      attributes: { type: 'Inkjet', ppm: '22', functions: 'Print, Scan, Copy' },
      tags: ['printer', 'inkjet', 'wireless'],
      variants: [{ color: 'White', stock: rand(5, 30) }],
    },
    {
      name: 'SmartSpeaker Echo Dot 5',
      description: 'Compact smart speaker with 360° sound, built-in voice assistant, and smart-home hub.',
      price: 49.99,
      subcategory: 'Smart Home',
      attributes: { driver: '1.73"', assistant: 'Alexa', connectivity: 'WiFi + Bluetooth 5.0' },
      tags: ['smart-speaker', 'alexa', 'smart-home'],
      variants: [
        { color: 'Charcoal', stock: rand(20, 100) },
        { color: 'Glacier White', stock: rand(20, 100) },
        { color: 'Deep Sea Blue', stock: rand(15, 70) },
      ],
    },
    {
      name: 'PocketProjector Mini 4K',
      description: 'Palm-sized 4K DLP projector with 1000 ANSI lumens, auto-keystone, and 3-hour battery.',
      price: 349.99,
      subcategory: 'Projectors',
      attributes: { resolution: '4K DLP', brightness: '1000 ANSI lm', battery: '3hr built-in' },
      tags: ['projector', 'portable', '4k'],
      variants: [{ color: 'White', stock: rand(5, 25) }],
    },
    {
      name: 'NVMe SSD PCIe 4.0 2TB',
      description: 'PCIe 4.0 M.2 NVMe SSD with 7400 MB/s sequential read and 5-year warranty.',
      price: 159.99,
      subcategory: 'Storage',
      attributes: { capacity: '2TB', readSpeed: '7400 MB/s', interface: 'PCIe 4.0 M.2' },
      tags: ['ssd', 'nvme', 'storage'],
      variants: [{ color: 'N/A', stock: rand(15, 70) }],
    },
    {
      name: 'QHD Monitor 27" 165Hz',
      description: '27" QHD IPS gaming monitor with 165Hz refresh, 1ms GTG, and HDR400 certification.',
      price: 319.99,
      subcategory: 'Monitors',
      attributes: { resolution: '2560×1440 QHD', refreshRate: '165Hz', panel: 'IPS HDR400' },
      tags: ['monitor', 'gaming', 'qhd'],
      variants: [{ color: 'Black', stock: rand(5, 25) }],
    },
    {
      name: 'Wireless Charging Pad 15W',
      description: 'Qi2-certified 15W fast wireless charging pad compatible with iPhone and Android.',
      price: 34.99,
      subcategory: 'Accessories',
      attributes: { standard: 'Qi2', maxWattage: '15W', compatibility: 'Universal Qi devices' },
      tags: ['charging', 'wireless', 'qi2'],
      variants: [
        { color: 'White', stock: rand(25, 100) },
        { color: 'Black', stock: rand(25, 100) },
      ],
    },
    {
      name: 'Action Camera 4K Ultra',
      description: 'Waterproof action camera with 4K/120fps, HorizonSteady stabilisation, and voice control.',
      price: 279.99,
      subcategory: 'Cameras',
      attributes: { resolution: '4K/120fps', waterproof: '10m', stabilisation: 'HorizonSteady' },
      tags: ['action-camera', '4k', 'waterproof'],
      variants: [
        { color: 'Black', stock: rand(10, 50) },
        { color: 'White', stock: rand(10, 50) },
      ],
    },
    {
      name: 'E-Reader Paperwhite 11th Gen',
      description: '6.8" glare-free e-ink display e-reader, waterproof (IPX8), with 16GB storage and warm light.',
      price: 139.99,
      subcategory: 'E-Readers',
      attributes: { display: '6.8" E-Ink', storage: '16GB', waterproof: 'IPX8' },
      tags: ['ereader', 'kindle', 'e-ink'],
      variants: [
        { color: 'Black', stock: rand(10, 60) },
        { color: 'Denim', stock: rand(10, 60) },
      ],
    },
  ],
